 ...
 * </pre>
 * <p>You activity (or fragment) needs to implement {@link ProductListDialogFragment.Listener}.</p>
 */
public class ProductListDialogFragment extends BottomSheetDialogFragment {
    ...
    public static ProductListDialogFragment newInstance(int itemCount) {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(new ProductAdapter(getArguments().getInt(ARG_ITEM_COUNT)));
    }
    ...
    private class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(LayoutInflater inflater, ViewGroup parent) {
            ...
            super(inflater.inflate(R.layout.fragment_product_list_dialog_item, parent, false));
