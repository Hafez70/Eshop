 ...
 * {@link fragment_wishlist.OnwishlistFragmentInteractionListener} interface
...
public class fragment_wishlist extends Fragment {
    ...
    private OnwishlistFragmentInteractionListener mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnwishlistFragmentInteractionListener) {
            mListener = (OnwishlistFragmentInteractionListener) context;
        } else {
     ...
     */
    public interface OnwishlistFragmentInteractionListener {
